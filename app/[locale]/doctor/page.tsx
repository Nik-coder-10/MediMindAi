                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="space-y-1.5 flex-1 min-w-[260px]">
                      <div className="flex flex-wrap items-center gap-2">
                        {/* Consultation Token Badge */}
                        <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-900 border border-emerald-300 dark:bg-emerald-950/80 dark:text-emerald-300">
                          {formatAyurToken(item.id)}
                        </span>
                    ...
                    {/* Registration Date & Time + Red Flag Badges */}
                    <div className="text-right space-y-2">
                      <div className="text-xs font-bold text-foreground bg-muted/50 px-2.5 py-1 rounded-lg border border-border inline-flex items-center gap-1.5">
                        <Clock className="h-3.5 w-3.5 text-emerald-600" />
                        <span>दर्ज (Registered): {formatDateTime(item.startedAt || item.updatedAt)}</span>
                      </div>
